...
#define SHKMyAppName			@"Glass"
#define SHKMyAppURL				@"http://writeonglass.com"
...
#define SHKFacebookKey				@"195366440525985"
#define SHKFacebookSecret			@"9e4f65c025f49f77ee573cc5c094d74f"
 ...
 */
#define SHKTwitterConsumerKey		@"9E7Tc2l9k2gyM5FauIxeyQ"
#define SHKTwitterSecret			@"ysEnnzOvSjEkiHNx3nNW21RjussFRRfdB1bnqZxHufQ"
#define SHKTwitterCallbackUrl		@"https://www.writeonglass.com/twitter_oauth_callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"borderstylo"
#define SHKBitLyKey					@"R_73c5d2c6cb7c53c5499cdfb12744e5cc"
